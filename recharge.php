    ...
    <div class="row justify-content-center align-items-center">
      <div class="col-md-4">
        <div class="form-container">
          ...
          <form method="post" action="rechargefunction.php">
            <input class="form-control form-control-lg" type="text" required pattern="\d+"  placeholder="Enter your pin here" aria-label=".form-control-lg example" title="Please enter only digits" id="pin" name="pin">
